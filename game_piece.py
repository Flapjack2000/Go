...
class GamePiece(Placeble):
    ...
    Methods:
        ...
        __repr__(): returns the string representation of the game piece when printing the board
    ...
    def __str__(self):
        ...
        """
        return f"{self.color.name} Piece"

    def __repr__(self):
        """
        Returns the string representation of the game piece when printing the board
        """
        representation = f'{self.color.name[0:4]}'
